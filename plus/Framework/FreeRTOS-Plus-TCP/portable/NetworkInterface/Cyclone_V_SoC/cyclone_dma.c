...
void gmac_dma_operation_mode( int iMacID,
							  int txmode,
							  int rxmode )
{
	uint8_t * ioaddr = ucFirstIOAddres( iMacID );
...
void gmac_set_dma_interrupt_enable( int iMacID,
									uint32_t ulMask )
{
	uint8_t * ioaddr = ucFirstIOAddres( iMacID );
...
uint32_t gmac_clear_dma_interrupt_status( int iMacID,
										  uint32_t ulMask )
{
	uint8_t * ioaddr = ucFirstIOAddres( iMacID );
	uint32_t ulValue;
...
uint32_t gmac_get_dma_interrupt_status( int iMacID,
										int iClear )
{
	uint8_t * ioaddr = ucFirstIOAddres( iMacID );
	uint32_t ulValue;
