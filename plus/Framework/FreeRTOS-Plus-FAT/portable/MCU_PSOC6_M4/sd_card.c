...
static uint8_t sd_cmd_spi( sd_card_t * this,
                           cmdSupported cmd,
                           uint32_t arg )
{
    uint8_t response;
...
static bool sd_wait_ready( sd_card_t * this,
                           int timeout )
{
    char resp;
...
static int sd_cmd( sd_card_t * this,
                   cmdSupported cmd,
                   uint32_t arg,
                   bool isAcmd,
                   uint32_t * resp )
...
static uint32_t ext_bits( unsigned char * data,
                          int msb,
                          int lsb )
{
    uint32_t bits = 0;
...
static int sd_read_bytes( sd_card_t * this,
                          uint8_t * buffer,
                          uint32_t length );
...
static bool sd_wait_token( sd_card_t * this,
                           uint8_t token )
{
                          ...
                          uint32_t length )
{
    ...
    #endif /* if SD_CRC_ENABLED */

    sd_deselect( this );
    return 0;
}
static int sd_read_block( sd_card_t * this,
                          uint8_t * buffer,
                          uint32_t length )
{
    uint16_t crc;
...
static int sd_read_blocks_unlocked( sd_card_t * this,
                                    uint8_t * buffer,
...
int sd_read_blocks( sd_card_t * this,
                    uint8_t * buffer,
                    uint64_t ulSectorNumber,
                    uint32_t ulSectorCount )
{
...
static uint8_t sd_write_block( sd_card_t * this,
 ...
 */
static int sd_write_blocks_unlocked( sd_card_t * this,
                                     const uint8_t * buffer,
                                     uint64_t ulSectorNumber,
                                     uint32_t blockCnt )
{
...
int sd_write_blocks( sd_card_t * this,
                     const uint8_t * buffer,
                     uint64_t ulSectorNumber,
                     uint32_t blockCnt )
{
