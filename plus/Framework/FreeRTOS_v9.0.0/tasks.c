	...
	TCB_t *pxTCB;
		...
		taskENTER_CRITICAL();
		{
			...
			if( pxTCB == pxCurrentTCB )
			{
				...
				/* Increment the uxDeletedTasksWaitingCleanUp variable so the idle task knows
...
static void prvCheckTasksWaitingTermination( void )
{
	...
	#if ( INCLUDE_vTaskDelete == 1 )
	{
		/* uxDeletedTasksWaitingCleanUp is used to prevent vTaskSuspendAll() being called
