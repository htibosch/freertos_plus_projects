...
#define GMAC_RX_BUFFERS  4 /* 48 * 128 = 6144 bytes = 4 full segments */

/** Number of buffer for TX */
#define GMAC_TX_BUFFERS  3  /* 2 * 1518 = 3036 bytes */


/** Number of buffer for RX */
#define MICREL_RX_BUFFERS  12  /* 96 * 128 = 12288 bytes = 8 full segments */

/** Number of buffer for TX */
//#define MICREL_TX_BUFFERS  32  /* 2 * 1518 = 3036 bytes */
#define MICREL_TX_BUFFERS  12  /* 2 * 1518 = 3036 bytes */
