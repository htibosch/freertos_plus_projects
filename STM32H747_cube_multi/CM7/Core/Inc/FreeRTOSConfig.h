...
#define configTOTAL_HEAP_SIZE					0x18000U
...
/* determines the actual clock speed. Normally it equals to the CPU clock, but not always. */
#define configSYSTICK_CLOCK_HZ					( 50000000U )
