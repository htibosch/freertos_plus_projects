 ...
 */
extern BaseType_t xApplicationMemoryPermissions( uintptr_t aAddress );
extern void vOutputChar( const char cChar, const TickType_t xTicksToWait  );

#ifdef __GNUC__

__attribute__((weak)) BaseType_t xApplicationMemoryPermissions( uintptr_t aAddress )
{
	( void ) aAddress;
	/* Return 1 for readable, 2 for writeable, 3 for both. */
	return 0x03;
...
static BaseType_t prints(struct SStringBuf *apBuf, const char *apString )
{
	...
	if( xApplicationMemoryPermissions( ( uintptr_t )apString ) == 0 )
	{
...
size_t gb, mb, kb, sb;
	...
	return apBuf;
		...
		int _vfprintf_l(FILE* const _Stream, char const* const _Format, _locale_t const _Locale, va_list   _ArgList)
		{
		...
		int _vsscanf_l( char const* const _Buffer, char const* const _Format, _locale_t const _Locale, va_list _ArgList)
		{
	...
	#if defined( _NO_CRT_STDIO_INLINE )
		int _vfscanf_l( _Inout_ FILE* const _Stream, char const* const _Format, const _Locale, va_list _ArgList )
		{
	...
	#if defined( _NO_CRT_STDIO_INLINE )
		int vsnprintf_s( char* const _Buffer, size_t const _BufferCount, size_t const _MaxCount, char const* const _Format, va_list _ArgList )
		{
			return _vsnprintf_s_l(_Buffer, _BufferCount, _MaxCount, _Format, NULL, _ArgList);
		}
		int _vsnprintf_s( char* const _Buffer, size_t const _BufferCount, size_t const _MaxCount, char const* const _Format, va_list _ArgList )
		{
			return _vsnprintf_s_l(_Buffer, _BufferCount, _MaxCount, _Format, NULL, _ArgList);
		}
	...
	#if defined( _NO_CRT_STDIO_INLINE )
		int _vsnprintf_s_l( char* const _Buffer, size_t const _BufferCount, size_t const _MaxCount, char const* const _Format,  _locale_t const _Locale, va_list _ArgList)
		{
