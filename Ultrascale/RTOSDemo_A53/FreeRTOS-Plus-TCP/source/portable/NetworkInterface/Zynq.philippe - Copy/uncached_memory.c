...
#define uncMEMORY_SIZE				0x400000ul
...
#define uncMEMORY_ATTRIBUTE			DEVICE_MEMORY
...
static uint8_t ucBuffer[ 0x200000ul ] __attribute__ ( ( aligned ( 2097152 ) ) );
...
static void vInitialiseUncachedMemory( )
{
	...
	pucStartOfMemory = ( uint8_t * ) ucBuffer;	// &( _end );
