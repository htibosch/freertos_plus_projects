...
C_SRCS += \
E:/Home/plus/UltraScale/SDK_WorkSpace_make/top_hw_platform_0/psu_init.c \
...
src/psu_init.o: E:/Home/plus/UltraScale/SDK_WorkSpace_make/top_hw_platform_0/psu_init.c
	@echo 'Building file: $<'
	@echo 'Invoking: ARM v8 gcc compiler'
	aarch64-none-elf-gcc -DARMA53_64 -Wall -O0 -g3 -c -fmessage-length=0 -MT"$@" -Os -flto -ffat-lto-objects -I../../fsbl_bsp/psu_cortexa53_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
